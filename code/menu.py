...
class Menu:
    ...
    def display_money(self):
        ...
        pygame.draw.rect(self.display_surf, 'White', text_rect.inflate(10,10), 0, 6)
    ...
    def update(self):
        self.input()
        self.display_money()
        # pygame.draw.rect(self.display_surf, 'red', self.main_rect)
        for text_index, text_surf in enumerate(self.text_surfs):
            ...
            # self.display_surf.blit(text_surf,(100, text_index *50) )
